...
const currentModel = "Qwen2.5-14B-Instruct-AWQ"
const logFileName = "benchmark_" + currentModel + ".log"

// Добавили константу для файла с ошибками
...
- OUTPUT ONLY VALID JSON. Do not write any thoughts, reasoning, or text before or after the JSON block.
...
func main() {
	...
	// Открываем второй файл для логов с ошибками
	...
	for _, entry := range entries {
		...
		dirPath := filepath.Join(supplyDir, entry.Name())
